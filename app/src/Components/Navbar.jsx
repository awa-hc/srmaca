...
export default function Navbar() {
  ...
  // Función para cambiar el states
  const toggleMenu = () => {
    ...
    <section className="flex md:m-0 md:gap-0 items-center justify-center top-0 fixed max-w-screen w-screen max-h-14 min-h-14 h-14 z-40 text-white px-4 py-5 md:px-24 md:py-4 uppercase font-bold font-sans rounded-2xl">
      <nav className="bg-transparent backdrop-blur-md w-[99vw]">
        <div className="w-[90vw] md:w-[95vw] flex flex-wrap items-center px-2 py-2 shadow-xl">
          ...
          <div
            className="hidden md:block w-full md:w-2/3 px-5"
            id="navbar-default"
          >
                    ...
                    {isOpen && (
                      ...
                      >
                        ...
                        <li className="menu-item transition duration-300  hover:bg-gradient-to-r hover:from-[#4e8666] hover:via-[#335984] hover:to-[#937244] hover:text-[#ffffff]">
                          <details>
                            <summary className=" uppercase">Combos</summary>
                            <ul className="">
      ...
      {menuOpen && (
        <ul
          className="absolute right-4 top-20 backdrop-blur-md text-white rounded-2xl"
          style={{
        ...
        >
          ...
          <li>
            <details>
              <summary className="py-2 px-4 uppercase">Productos</summary>
              <ul className="">
                <li className="block text-sm py-1 px-6">
                  <a href="/buy/testo-plus">Testo Plus</a>
                </li>
          ...
          <li>
            <a href="/contact" className="block py-2 px-4 uppercase">
              CONTACTO
            </a>
          </li>
          {userLogged ? (
