...
const Combo2 = () => {
    const [mainImage, setMainImage] = useState("/images/combo2/combo2.png");
            ...
            <a href="/images/combo2/combo2.png" data-fancybox="gallery">
                ...
                />
                    ...
                    <div className="thumbnails">
                        <img className="thumbnail" src="/images/combo2/combo2.png" alt="combo2" onClick={changeMainImage}/>
                    </div>
                </div>
            </div>
        </div>
